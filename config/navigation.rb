SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    primary.dom_attributes = { class: 'navbar-start' }
    ...
    #
    primary.item :kits, 'Модели', kits_path, html: { class: 'navbar-item' }
    primary.item :categories, 'Категории', categories_path, html: { class: 'navbar-item' }
    primary.item :scales, 'Масштабы', scales_path, html: { class: 'navbar-item' }
